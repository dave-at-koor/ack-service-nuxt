  ...
  <header class="bg-white">
    ...
    >
      <a href="/" class="-m-1.5 p-1.5">
        <span class="sr-only">Koor</span>
        <img
          class="h-8 w-auto"
          src="/koor-logo-42.png"
          alt="Logo for Koor Technologies, Inc"
        />
      </a>
    ...
    >
      ...
      >
        <div class="flex items-center justify-between">
          <a href="#" class="-m-1.5 p-1.5">
            <span class="sr-only">Koor Technologies, Inc.</span>
            <img class="h-8 w-auto" src="koor-icon.png" alt="" />
          </a>
          <button
            type="button"
